...
height_label = Label(root, text="Height (cm)", font="arial 12", bg="#f0f1f5", fg="#3b3a3a")
height_label.place(x=35, y=115)

weight_label = Label(root, text="Weight (kg)", font="arial 12", bg="#f0f1f5", fg="#3b3a3a")
weight_label.place(x=255, y=115)
